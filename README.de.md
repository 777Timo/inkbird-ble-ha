...
5. Bluetooth-Adresse des Geräts eingeben
...
|---------|-----|--------------|
| Innentemperatur / Sonde 0 | Sensor | Grill-Sonde (°C/°F) |
| Sonde 1–3 | Sensor | Externe Sonden (°C/°F) |
| Lüfter Ist-Drehzahl | Sensor | Aktueller Gebläsewert (%) |
| Zieltemperatur (Gerät) | Sensor | Vom Gerät gelesene Zieltemperatur (°C/°F) |
| Grill-Zieltemperatur | Number | Zieltemperatur setzen (20–300°C) |
| Sonde 1–3 Alarm-Temperatur | Number | Alarm-Temperatur je Sonde setzen (20–300°C) |
...
| FFF3 | `0000fff3-...` | Grill-Zieltemperatur + Sonden-Alarme (Read/Write, 20 Bytes) |
